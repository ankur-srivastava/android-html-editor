...
protected void onDraw(Canvas canvas) {
    ...
    getPaint().setShader(new LinearGradient(0, getHeight(), 0, 0, Color.parseColor("#bccad3"), Color.parseColor("#f6fafc"), TileMode.CLAMP)); // or whatever gradient/shader you use
    super.onDraw(canvas);
}
