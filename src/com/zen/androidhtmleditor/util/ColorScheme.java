...
public class ColorScheme
{
    ...
    public static int color_font = 0; //文字颜色
    
    private final static String BACKGROUP_COLOR = "#ffffff";
    public static int color_backgroup = 0; //背景颜色
    
    private final static String STRING_COLOR = "#008800"; //008800
    public static int color_string = 0; //string content
    
    private final static String KEYWORD_COLOR = "#000088";
    public static int color_keyword = 0; //keyword
    
    private final static String COMMENT_COLOR = "#3F7F5F";
    public static int color_comment = 0; //comment
    
    private final static String TAG_COLOR = "#800080";
    public static Integer color_tag = 0; //a markup tag name
    
    private final static String ATTR_NAME_COLOR = "#FF0000";
    public static int color_attr_name = 0; //attribute name
    
    private final static String FUNCTION_COLOR = "#000080";
    public static int color_function = 0; //html or xml tag color
   ...
   /* public static void set(SharedPreferences mSharedPreferences, String themeName)
    {
        loadAllScheme();
    ...
    /*public static void loadAllScheme()
    {
        if(schemeTables.size() > 0)
            return;
        File files = new File(EditFile.TEMP_PATH+"/colors");
