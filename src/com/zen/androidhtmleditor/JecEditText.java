...
import com.zen.androidhtmleditor.util.TextUtil;
...
public class JecEditText extends EditText
{
    ...
    static boolean mShowLineNum = true;
    ...
    private final static int LAST_EDIT_DISTANCE_LIMIT = 20; //
    ...
    public void init()
    {
       ...
       // addTextChangedListener(mUndoWatcher);
        ...
        mLineNumberPaint.setColor(ColorScheme.color_font);
   ...
   /* private TextWatcher mUndoWatcher = new TextWatcher() {
    ...
    public void setPath(String path)
    {
        ...
        setCurrentFileExt(EditFile.ext);
        //setCurrentFileExt("php");
    }
