...
#include "com_zen_androidhtmleditor_highlight_Highlight.h"
...
/*
 * Class:     com_zen_androidhtmleditor_highlight_Highlight
 * Method:    read_file
 * Signature: (Ljava/lang/String;)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_zen_androidhtmleditor_highlight_Highlight_read_1file(JNIEnv *env, jclass cls, jstring file)
{
	char *buffer;
	const char *path;
	jboolean iscopy;
 ...
 */
JNIEXPORT jintArray JNICALL Java_com_zen_androidhtmleditor_highlight_Highlight_jni_1parse(JNIEnv *env, jclass cls, jstring text, jstring syntaxfile)
{
	int textfilesize;
